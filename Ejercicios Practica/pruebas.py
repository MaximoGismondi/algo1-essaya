...
#     return len({palabra for palabra in texto.split()})
...
# # print(contar_palabras_unicas(texto))

# with open("C:\ALGO 1\hola.txt", 'r') as f:
#     for _ in range(5):
#         print(next(f))
...
def draw_window(surface):
    ...
    pygame.draw.rect(surface, (128, 128, 128), (top_left_x,

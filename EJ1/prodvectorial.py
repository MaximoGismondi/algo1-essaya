def producto_vectorial(x1, y1, z1, x2, y2, z2):
    ...
    resultado_x = y1*z2 - z1*y2
    resultado_y = z1*x2 - x1*z2
    resultado_z = x1*y2 - y1*x2

    # print("Resultado x: ", resultado_x)
    # print("Resultado y: ", resultado_y)
    # print("Resultado z: ", resultado_z)
